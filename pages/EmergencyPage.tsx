...
const EmergencyPage: React.FC = () => {
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-dark text-center">Emergency Services (SOS)</h2>
      <p className="text-gray-600 text-center">Tap a service to call immediately.</p>
      ...
      <div className="pt-4">
        <h3 className="font-bold text-xl text-dark mb-3">Local Contacts</h3>
        <div className="space-y-3">
            <div className="bg-white p-4 rounded-lg flex justify-between items-center shadow-sm">
                <div>
                    <p className="font-semibold">Georgetown Public Hospital</p>
                    <p className="text-sm text-gray-500">592-227-8200</p>
                </div>
                <a href="tel:592-227-8200" className="p-3 bg-light rounded-full text-primary"><PhoneIcon className="w-5 h-5"/></a>
            </div>
             <div className="bg-white p-4 rounded-lg flex justify-between items-center shadow-sm">
                <div>
                    <p className="font-semibold">My Personal Contact</p>
                    <p className="text-sm text-gray-500">John Smith</p>
                </div>
                <a href="tel:592-123-4567" className="p-3 bg-light rounded-full text-primary"><PhoneIcon className="w-5 h-5"/></a>
            </div>
        </div>
