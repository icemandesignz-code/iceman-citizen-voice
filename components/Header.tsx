...
const Header: React.FC<HeaderProps> = ({ title, user, onAvatarClick, onLoginClick, onSearchClick, showBackButton, onBack }) => {
  return (
    <header className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md sticky top-0 z-30 p-4 flex items-center justify-between border-b border-gray-200/50 dark:border-gray-700/50">
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h1 className="font-bold text-xl text-dark dark:text-white leading-tight">{title}</h1>
